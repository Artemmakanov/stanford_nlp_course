...
\begin{parts}
    ...
    \part[4] Adam Optimizer\newline
        ...
        \begin{subparts}
            ...
            \ifans{
            	When we use momentum,  inertia appears in learning process - it becomes more difficult to change the direction of the optimization.
            	Momentum helps in reducing the noise in gradient update term and thus helps to converge faster to the optimal (or near optimal) value.
            }\newline
            ...
            \ifans{
            	...
            	Lower parameters get lager update with the help of the adaptive learning rates.
            	It helps us to avoid saddle points and catch true directions of optimizations, even if gradients are small. 
            }\newline
    ...
    \part[4] 
        ...
        \begin{subparts}
            ...
            \ifans{
            	Dropout prevents overfitting and provides a way of approximately combining exponentially many different neural network architectures efficiently. Dropout makes neurons output 'wrong' values on purpose. Because you disable neurons randomly, your network will have different outputs every activation. This undermines consistency, so dropout should not be applied during evaluation.
            	\
            }\newline
